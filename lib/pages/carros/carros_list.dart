...
class _CarrosListViewState extends State<CarrosListView> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: _bloc.stream, // lib\utils\bloc.dart
      builder: (context, snapshot) {
        if (snapshot.hasError) {
          return TextError(
              "Não foi possível buscar os carros"); // lib\widgets\text_error.dart
        }
        ...
        return Container(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return StackMaterialContainer( // lib\widgets\material_container.dart
                child: _cardCarro(c),
          ...
          child: Container(
            child: Column(
              ...
              children: <Widget>[
                ...
                Center(
                  child: text( // lib\widgets\text.dart
                    c.nome ?? "",
