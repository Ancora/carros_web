...
//        width: 350,
  ...
  _foto() {
    ...
    return ConstrainedBox(
      ...
      child: url != null
          ? Image.network(url)
          : Image.asset("assets/imgs/car_logo.png", color: AppColors.bg),
    );
  }
...
//              textAlign: TextAlign.left,
  ...
  _radioTipo() {
    return Row(
      ...
      children: <Widget>[
        ...
        Text(
          "Clássicos",
          style: TextStyle(color: AppColors.texto, fontSize: 14),
        ),
        Radio(
          value: 1,
          groupValue: _radioIndex,
  ...
  _onClickSalvar() async {
    ...
    ApiResponse response =
        await CarrosApi.save(context, c); // utils/api_response.dart
